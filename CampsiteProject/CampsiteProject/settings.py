...
SECRET_KEY = 'django-insecure-3u&+zh#372m7&o)f$2pu51kfwi3#y0-)3rky1+s4wd&w0d18m#'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'campsite',       # Your MySQL database name
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'CampsiteApp/static')]
